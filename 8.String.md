...
After creation, string operations use `String` methods. Note that `String` is immutable — any modification creates a new `String` object.
...
- Comparing two strings should compare their contents, not references — use `equals()`.
...
```
![strings](./images/ways-of-creating-string.png)
![strings](./images/scp.png)
